...
import {
  createProductHistoryUtil,
  DeleteProductHistoryUtil,
  existProductHistoryUtil,
  getProductHistoryUtil,
  updateProductHistoryUtil,
} from '../../utils/productHistory';

export const createProductHistory = async (req: Request, res: Response) => {
  req.logger = req.logger.child({
    service: 'product history',
    serviceHandler: 'createProductHistory',
  });
...
export const getProductsHistory = async (req: Request, res: Response) => {
  req.logger = req.logger.child({
    service: 'product history',
    serviceHandler: 'getProductsHistory',
  });
  req.logger.info({ status: 'start' });
...
export const deleteProductHistory = async (req: Request, res: Response) => {
  req.logger = req.logger.child({
    service: 'product history',
    serviceHandler: 'deleteProductHistory',
  });
  req.logger.info({ status: 'start' });
