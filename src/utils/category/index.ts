...
export const createCategoryUtil = async (title: string) => {
  try {
    return await new Promise((resolve, reject) => {
      dataBase.query(`INSERT INTO category (titleCategory) VALUES ('${title}');`, (err, data) =>
...
export const getExitsCategoryUtil = async (title: string) => {
  try {
    return (await new Promise((resolve, reject) => {
      dataBase.query(`SELECT * FROM category WHERE titleCategory = '${title}';`, (err, data) =>
        err ? reject(err) : resolve(data),
      );
    })) as Category[];
  } catch (error) {
...
export const getCategorysUtil = async () => {
  try {
    return (await new Promise((resolve, reject) => {
      dataBase.query(`SELECT * FROM category ORDER BY idCategory DESC;`, (err, data) =>
        err ? reject(err) : resolve(data),
      );
    })) as Category[];
  } catch (error) {
...
export const deleteCategoryUtil = async (title: string) => {
  try {
    return await new Promise((resolve, reject) => {
      dataBase.query(`DELETE FROM category WHERE titleCategory = '${title}';`, (err, data) =>
        err ? reject(err) : resolve(data),
      );
    });
  } catch (error) {
